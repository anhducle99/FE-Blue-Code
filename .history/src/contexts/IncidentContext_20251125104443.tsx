...
export const IncidentProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  // Track if initial load has been done to prevent overwriting real-time incidents
  ...
  const loadCallHistory = useCallback(async () => {
    ...
    try {
      ...
      setIncidents((prevIncidents) => {
        ...
        // If this is the initial load, replace everything
  ...
  useEffect(() => {
    if (user) {
      ...
      if (!hasLoadedRef.current || user.id !== hasLoadedRef.current) {
