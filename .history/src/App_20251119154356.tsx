  ...
  return (
    <div className="min-h-screen h-screen overflow-hidden bg-white flex flex-col">
      ...
      <div className="flex-1 overflow-hidden px-4 pb-6">
        <div className="grid h-full gap-4 grid-cols-1 md:grid-cols-[minmax(0,1.6fr)_minmax(0,1fr)] md:grid-rows-[auto,minmax(0,1fr)] overflow-y-auto md:overflow-visible pb-4">
