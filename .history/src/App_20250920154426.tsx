...
export default function App() {
  ...
  // Lọc những item hiển thị, loại bỏ "Lãnh Đạo"
  const visibleDepartments = useMemo(
    () => departments.filter((d: any) => d.alert_group !== "Lãnh Đạo"),
    [departments]
  );

  const visibleSupportContacts = useMemo(
    () => supportContacts.filter((s: any) => s.label !== "Lãnh Đạo"),
    [supportContacts]
  );
