...
export default function App() {
  ...
  const [statusWidgetHeight, setStatusWidgetHeight] = useState(0);
  ...
  return (
    <div className="min-h-screen h-screen overflow-hidden bg-white flex flex-col">
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Main Content - 2/3 */}
        <main className="w-2/3 px-4 pb-6 flex flex-col gap-4 overflow-hidden">
          ...
          <div
            ...
            style={{
              marginTop:
                isDesktop && statusWidgetHeight > 0
                  ? statusWidgetHeight + 12
                  : 0,
            }}
          >
            <IncidentTrendChart />
        ...
        <RightSidebar
          ...
          onClose={() => {}}
          onStatusHeightChange={(height) => setStatusWidgetHeight(height)}
        />
      </div>
