  ...
  return (
    <div className="min-h-screen h-screen overflow-hidden bg-white flex flex-col">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-4 overflow-hidden">
        {/* Main Content - spans 3/4 on large screens */}
        <main className="col-span-1 lg:col-span-3 px-4 pb-6 flex flex-col gap-4 overflow-hidden">
        ...
        {/* Right Sidebar - spans 1/4 on large screens */}
