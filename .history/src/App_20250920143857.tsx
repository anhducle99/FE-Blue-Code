...
export default function App() {
  ...
  // Lấy dữ liệu realtime từ DashboardProvider
  const {
    group1,
    group2,
    supportContacts: contextSupportContacts,
  } = useDashboardContext();
  const departments = [...group1, ...group2];
  const supportContacts = contextSupportContacts || [];
  ...
  useEffect(() => {
    ...
    if (!hasSeen && !isLoginPage) setAudioModalOpen(true);
  }, [isLoginPage]);
