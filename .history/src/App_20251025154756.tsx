...
export default function App() {
  ...
  // ✅ Mở modal xin quyền phát âm thanh lần đầu
  useEffect(() => {
  ...
  // ✅ Toggle chọn / bỏ chọn 1 khoa hoặc nhóm hỗ trợ
  ...
  // ✅ Chọn tất cả (trừ khoa và nhóm trùng với user)
  const selectAll = () => {
    ...
    <div className="min-h-screen h-screen overflow-y-auto bg-white">
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-grow px-4 pb-10">
          {/* Lưới các nút phòng ban và nhóm hỗ trợ */}
