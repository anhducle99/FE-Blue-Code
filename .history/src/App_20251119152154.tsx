  ...
  return (
    <div className="min-h-screen h-screen overflow-hidden bg-white flex flex-col">
      ...
      <div className="flex-1 overflow-hidden px-4 pb-6">
        <div className="grid h-full gap-4 grid-cols-1 lg:grid-cols-[2fr,1fr] lg:grid-rows-[auto,minmax(0,1fr)]">
          {/* Left Column - Row 1: Department controls */}
          <section className="flex flex-col min-h-0 overflow-hidden xl:row-start-1 xl:row-end-2 xl:col-start-1 xl:col-end-2">
          ...
          {/* Right Column - Row 1: Status widget */}
          <div className="xl:row-start-1 xl:row-end-2 xl:col-start-2 xl:col-end-3 min-h-0">
            <IncidentStatusWidget />
          </div>

          {/* Left Column - Row 2: Trend chart */}
          <div className="min-h-0 xl:row-start-2 xl:row-end-3 xl:col-start-1 xl:col-end-2">
            <IncidentTrendChart />
          </div>

          {/* Right Column - Row 2: Incident list */}
          <div className="min-h-0 xl:row-start-2 xl:row-end-3 xl:col-start-2 xl:col-end-3">
