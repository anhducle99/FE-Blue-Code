...
export default function App() {
  ...
  // ✅ giữ lại danh sách người được gọi để hiển thị trong CallStatusModal
  ...
  const handleConfirmCall = async () => {
    try {
      ...
      if (res.data.success) {
        ...
        // ✅ Lưu danh sách người nhận trước khi reset
        const names = selectedKeys.map((k) => k.split("_")[0]);
        setCallTargets(names);

        // Gửi tín hiệu bắt đầu cuộc gọi
  ...
  return (
    <div className="min-h-screen h-screen overflow-y-auto bg-white">
      ...
      {/* ✅ Sử dụng callTargets thay vì selectedNames */}
      <CallStatusModal
