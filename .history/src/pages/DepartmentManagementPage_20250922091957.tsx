...
export const DepartmentManagementPage: React.FC = () => {
  ...
  // Lấy danh sách departments từ backend
  ...
  }, [modalOpen, editingDept]);

  const handleSave = async () => {
    if (!formData.name?.trim() || !formData.alert_group) {
    ...
    try {
      ...
      if (editingDept?.id) {
        ...
        message.success("Thêm mới khoa/phòng thành công");
      }
      fetchDepartments();
      setModalOpen(false);
      setEditingDept(null);
