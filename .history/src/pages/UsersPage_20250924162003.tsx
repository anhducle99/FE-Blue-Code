...
// FE Form type
interface IUserFormFE extends IUserForm {
  departmentName: string;
  password?: string; // mật khẩu khi tạo mới
}
...
export const UsersPage: React.FC = () => {
  ...
  const formik = useFormik<IUserFormFE>({
    initialValues: {
      organization_id: 0,
      department_id: 0,
      departmentName: "",
    ...
    onSubmit: async (values) => {
      try {
        ...
        // xác định role tự động
        const role: "Admin" | "User" = values.departmentName
          .toLowerCase()
          .includes("lãnh đạo")
          ? "Admin"
          : "User";

        // tạo payload backend (chỉ IUserForm)
