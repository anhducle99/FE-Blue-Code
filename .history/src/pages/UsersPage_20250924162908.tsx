  ...
  const formik = useFormik<IUserForm>({
    ...
    onSubmit: async (values) => {
      try {
        ...
        // Xác định role tự động theo department name nếu muốn
        const role: "Admin" | "User" = values.role || "User";
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              <Select
                ...
                value={formik.values.organization_id || undefined} // phải undefined khi chưa chọn
                onChange={(val: number) =>
                  formik.setFieldValue("organization_id", val)
                }
                className="w-full"
              >
