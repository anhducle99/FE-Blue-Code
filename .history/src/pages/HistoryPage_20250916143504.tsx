...
export const HistoryPage: React.FC = () => {
  ...
  // state thật sự để gọi API
  const [searchFilters, setSearchFilters] = useState<typeof filters>({
    nguoi_gui: "",
    nguoi_nhan: "",
    bat_dau: "",
    ket_thuc: "",
  ...
  const handleSearch = () => {
    // copy filters sang searchFilters
    ...
    <>
      ...
      <div className="mx-4 mt-2 bg-white rounded shadow-sm p-4">
        ...
        <div className="overflow-auto">
          {/* chỉ truyền searchFilters vào table */}
          <HistoryTable filters={searchFilters} />
        </div>
      </div>
    </>
  );
