...
export const UsersPage: React.FC = () => {
  ...
  // Update Formik mỗi khi editingUser thay đổi
  useEffect(() => {
    if (editingUser) {
      formik.setValues({
        ...
        isDepartmentAccount: editingUser.isDepartmentAccount || false,
        isDepartment: editingUser.isDepartment || false,
