...
export const DepartmentManagementPage: React.FC = () => {
  ...
  const [allItems, setAllItems] = useState<IDepartment[]>([]);

  // Mapping alert_group -> màu cho SupportContact
  ...
  const fetchDepartments = async () => {
    try {
      ...
      // Context departments / supportContacts
      ...
      // State bảng hiển thị tất cả
      setAllItems(allDepts);
    } catch (err) {
      console.error(err);
