...
const IncidentSidebar: React.FC<IncidentSidebarProps> = ({
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className="flex items-center justify-between p-3 md:p-4 border-b flex-shrink-0"
        style={{ borderColor: "rgba(255, 255, 255, 0.1)" }}
      >
        <h2 className="text-base md:text-lg font-bold">Sự cố và cảnh báo</h2>
        <div className="flex items-center gap-2">
          <select
            ...
            className="text-white px-2 md:px-3 py-1 rounded border text-xs md:text-sm"
            style={{
      ...
      {filteredIncidents.length > 0 && (
        <div
          className="border-t p-3 md:p-4 flex-shrink-0"
          style={{ borderColor: "rgba(255, 255, 255, 0.1)" }}
        >
          <div className="flex items-center justify-between mb-2 flex-wrap gap-2">
            ...
            <select
              ...
              className="text-white px-2 py-1 rounded border text-xs md:text-sm"
              style={{
                backgroundColor: "rgba(0, 0, 0, 0.2)",
                borderColor: "rgba(255, 255, 255, 0.2)",
              }}
          ...
          <div className="flex items-center justify-center gap-1 flex-wrap">
              ...
              return (
                <button
                  ...
                  className={`px-2 md:px-3 py-1 rounded text-xs md:text-sm ${
                    currentPage === pageNum ? "bg-blue-600 text-white" : "text-white"
                  }`}
                  style={{
            ...
            {totalPages > 5 && currentPage < totalPages - 2 && (
              <span className="px-1 md:px-2 text-white/70 text-xs md:text-sm">...</span>
            )}
            {totalPages > 5 && currentPage < totalPages - 2 && (
              <button
