...
const IncidentSidebar: React.FC<IncidentSidebarProps> = ({
  ...
  return (
    <div className="h-full w-full text-white flex flex-col overflow-hidden" style={{ backgroundColor: 'rgb(3 101 175)' }}>
      {/* Header */}
        ...
        <div className="border-t border-slate-700 p-4">
          ...
          <div className="flex items-center justify-center gap-1">
            <button
              ...
              className="px-2 py-1 bg-slate-800 rounded disabled:opacity-50 disabled:cursor-not-allowed hover:bg-slate-700"
            >
              &lt;&lt;
            </button>
            <button
