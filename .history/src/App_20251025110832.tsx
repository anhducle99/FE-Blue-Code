...
export default function App() {
  ...
  useEffect(() => {
    ...
    // 🔊 Tạo âm thanh gọi đến
    const audio = new Audio("/sound/aa.ts");
    audio.loop = true; // lặp lại cho đến khi người dùng phản hồi

    // 🔒 Kiểm tra quyền phát âm thanh
    ...
    // 🧹 Dừng âm thanh khi tắt modal hoặc người dùng phản hồi
    return () => {
      audio.pause();
      audio.currentTime = 0;
    };
