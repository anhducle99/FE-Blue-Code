...
export const DashboardProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const setFromAPI = (
   // Giả sử res.data.data là mảng khoa/phòng từ API
const allDepts = res.data.data;

// Nhóm Y tế vào departments
const deptGroup: Department[] = allDepts
  .filter(d => d.alert_group === "Y tế" && d.phone)
  .map(d => ({
    name: d.name,
    phone: d.phone!,
  }));

// Nhóm còn lại vào supportContacts, loại trừ "Lãnh Đạo"
