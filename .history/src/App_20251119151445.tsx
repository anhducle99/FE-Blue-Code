    ...
    <div className="min-h-screen h-screen overflow-hidden bg-white flex flex-col">
      ...
      <div className="flex-1 overflow-hidden px-4 pb-6">
        <div className="grid h-full gap-4 grid-cols-1 xl:grid-cols-[2fr,1fr] xl:grid-rows-[auto,minmax(0,1fr)]">
          ...
          <section className="flex flex-col min-h-0 overflow-hidden xl:row-[1/2] xl:col-[1/2]">
          ...
          <div className="xl:row-[1/2] xl:col-[2/3] min-h-0">
            <IncidentStatusWidget />
          </div>

          {/* Left Column - Row 2: Trend chart */}
          <div className="min-h-0 xl:row-[2/3] xl:col-[1/2]">
            <IncidentTrendChart />
          </div>

          {/* Right Column - Row 2: Incident list */}
          <div className="min-h-0 xl:row-[2/3] xl:col-[2/3]">
